...
function MainSpeakers() {
    ...
    const targetData = products.filter(item => item.category === "speakers")
    const sortProducts = targetData.sort((itemA, itemB) => itemA.slug < itemB.slug)
    console.log("products-mainSpeakers", products)
    console.log("targetData-mainSpeakers", targetData)
    console.log("sortProducts-mainSpeakers", sortProducts)
