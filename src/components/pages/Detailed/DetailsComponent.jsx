...
function DetailsComponent() {
  ...
  const { id } = useParams()
  const { products } = useContext(ProductContext); // get all products from context
  ...
  const getProduct = products.find((p) => p.slug === id); // match id

 console.log("getProduct", getProduct)
  // const getProduct = data.products.find(product => id === product.id)
  ...
  if (!getProduct) return <p>Loading...</p>;
    ...
    <main className='main'
      ...
      <div className='other-products container'>
        ...
        <ul className='other-products-list'>
          ...
          {otherProducts.map((product, idx) => <li key={product.id}
